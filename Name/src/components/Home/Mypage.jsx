  ...
  return (
    <div className="py-80 relative overflow-hidden px-6 min-h-screen">
         <div className="relative z-10 m-auto text-center">
            <h1 className="text-white font-bold font-josefin tracking-widest text-6xl md:text-7xl lg:text-8xl xl:text-9xl ">GOVIND S KUMAR</h1>
            <h2 className="text-white font-bold text-lg text-center md:text-2 lg:text-3xl xl:text-4xl font-josefin tracking-widest uppercase mt-4">FRONT-END DEVELOPER</h2>
         </div>
